    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class = myimg src="assets/img/logo.png" alt="..." /><!---class="masthead-avatar mb-5" -->
                <!-- Masthead Heading-->
                <!-- <h1 class="masthead-heading text-uppercase mb-0">DATABASE MANEGEMENT SYSTEM</h1> -->
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">DATABASE MANEGEMENT SYSTEM</p>
            </div>
        </header>
        <!-- BODY Section-->
